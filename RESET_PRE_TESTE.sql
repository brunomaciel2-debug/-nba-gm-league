...
TRUNCATE TABLE gleague_box_scores CASCADE;
...
TRUNCATE TABLE social_media_events CASCADE;
TRUNCATE TABLE gm_satisfaction_snapshots CASCADE;
TRUNCATE TABLE gm_tenure_log CASCADE;
TRUNCATE TABLE gm_season_targets CASCADE;
...
TRUNCATE TABLE player_transactions CASCADE;
...
TRUNCATE TABLE retirement_decisions CASCADE;
TRUNCATE TABLE psychology_slots CASCADE;
...
INSERT INTO gleague_box_scores SELECT * FROM gleague_box_scores_preteste;
...
INSERT INTO social_media_events SELECT * FROM social_media_events_preteste;
INSERT INTO gm_satisfaction_snapshots SELECT * FROM gm_satisfaction_snapshots_preteste;
INSERT INTO gm_tenure_log SELECT * FROM gm_tenure_log_preteste;
INSERT INTO gm_season_targets SELECT * FROM gm_season_targets_preteste;
...
INSERT INTO player_transactions SELECT * FROM player_transactions_preteste;
...
INSERT INTO arena_audience_modifiers SELECT * FROM arena_audience_modifiers_preteste;
...
INSERT INTO tactical_focus SELECT * FROM tactical_focus_preteste;
...
INSERT INTO retirement_decisions SELECT * FROM retirement_decisions_preteste;
INSERT INTO psychology_slots SELECT * FROM psychology_slots_preteste;
