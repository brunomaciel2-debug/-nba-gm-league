...
TRUNCATE TABLE gleague_box_scores_preteste CASCADE;
...
TRUNCATE TABLE social_media_events_preteste CASCADE;
TRUNCATE TABLE gm_satisfaction_snapshots_preteste CASCADE;
TRUNCATE TABLE gm_tenure_log_preteste CASCADE;
TRUNCATE TABLE gm_season_targets_preteste CASCADE;
...
TRUNCATE TABLE player_transactions_preteste CASCADE;
...
TRUNCATE TABLE arena_audience_modifiers_preteste CASCADE;
...
TRUNCATE TABLE rising_stars_roster_preteste CASCADE;
TRUNCATE TABLE playoff_series_preteste CASCADE;
TRUNCATE TABLE gleague_playoff_series_preteste CASCADE;
TRUNCATE TABLE retirement_decisions_preteste CASCADE;
TRUNCATE TABLE psychology_slots_preteste CASCADE;
...
INSERT INTO gleague_box_scores_preteste SELECT * FROM gleague_box_scores;
...
INSERT INTO social_media_events_preteste SELECT * FROM social_media_events;
INSERT INTO gm_satisfaction_snapshots_preteste SELECT * FROM gm_satisfaction_snapshots;
INSERT INTO gm_tenure_log_preteste SELECT * FROM gm_tenure_log;
INSERT INTO gm_season_targets_preteste SELECT * FROM gm_season_targets;
...
INSERT INTO player_transactions_preteste SELECT * FROM player_transactions;
...
INSERT INTO arena_audience_modifiers_preteste SELECT * FROM arena_audience_modifiers;
...
INSERT INTO rising_stars_roster_preteste SELECT * FROM rising_stars_roster;
INSERT INTO playoff_series_preteste SELECT * FROM playoff_series;
INSERT INTO gleague_playoff_series_preteste SELECT * FROM gleague_playoff_series;
INSERT INTO retirement_decisions_preteste SELECT * FROM retirement_decisions;
INSERT INTO psychology_slots_preteste SELECT * FROM psychology_slots;
