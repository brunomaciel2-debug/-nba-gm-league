...
TRUNCATE TABLE summer_league_rosters_preteste CASCADE;
TRUNCATE TABLE summer_league_games_preteste CASCADE;
TRUNCATE TABLE summer_league_box_scores_preteste CASCADE;
...
TRUNCATE TABLE draft_config_preteste CASCADE;
TRUNCATE TABLE prospects_preteste CASCADE;
TRUNCATE TABLE training_slots_preteste CASCADE;
TRUNCATE TABLE tactical_familiarity_preteste CASCADE;
TRUNCATE TABLE tactical_focus_preteste CASCADE;
...
TRUNCATE TABLE referees_preteste CASCADE;
...
INSERT INTO summer_league_rosters_preteste SELECT * FROM summer_league_rosters;
INSERT INTO summer_league_games_preteste SELECT * FROM summer_league_games;
INSERT INTO summer_league_box_scores_preteste SELECT * FROM summer_league_box_scores;
...
INSERT INTO draft_config_preteste SELECT * FROM draft_config;
INSERT INTO prospects_preteste SELECT * FROM prospects;
INSERT INTO training_slots_preteste SELECT * FROM training_slots;
INSERT INTO tactical_familiarity_preteste SELECT * FROM tactical_familiarity;
INSERT INTO tactical_focus_preteste SELECT * FROM tactical_focus;
