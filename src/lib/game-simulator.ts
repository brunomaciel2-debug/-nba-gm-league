...
// Assist-on-make base rate: was .78 for a plain make and .40 for an and-one,
// both well above the real NBA's ~60-65% of made shots being assisted — a
// real incident: several players with a modest hidden assist_rate (55-62,
// meant to translate to ~5 apg36) were averaging 9-10 real assists/game,
// because the sheer volume of assist "opportunities" a team generated
// outweighed how selectively apg36/astTaper distributed them. Lowered to
// .62/.28 (still and-ones assisted less often than plain makes, same as
