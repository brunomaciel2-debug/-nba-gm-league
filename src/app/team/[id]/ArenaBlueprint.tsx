...
const SLOTS: SlotDef[] = [
  {
    ...
    synergies:['3 stalls in different corridors → +4% adoption','Jumbotron → +5% all food','Team in good form (65%+ win rate) → +8%'],
    penalties:['2 stalls same corridor → second loses -10%','Premium Food same corridor → -8%','Team in poor form (35%- win rate) → -10%'],
  ...
  },
  {
    ...
    synergies:['VIP Restaurant nearby → +5%','Playoffs → +15%'],
  ...
  },
  {
    ...
    synergies:['Rivalry game → +10%','Club Seats nearby → +5%'],
    penalties:['Both bars active → each -3% (split audience)'],
  ...
  },
  {
    ...
    synergies:['Courtside Lounge → +10% VIP adoption','Corporate Suites → +6%'],
    penalties:['No Courtside or Suites → -6%','Poor team form → -4%'],
  ...
  },
  {
    ...
    synergies:['Mascot nearby → +5%','Team in good form → +10%','Playoffs → +20%'],
    penalties:['Team in poor form → -8%'],
  ...
  },
  {
    ...
    synergies:['Courtside Lounge → +15% suite revenue'],
    penalties:[],
  ...
  },
  {
    ...
    synergies:['No synergy with other slots — fixed, predictable revenue every game'],
    penalties:[],
  ...
  },
  {
    ...
    synergies:['VIP Restaurant → package deal +10%'],
    penalties:['No VIP Restaurant → -10% revenue'],
  ...
  },
  {
    ...
    synergies:['Jumbotron → +8%','Mascot → +6%'],
  ...
  },
  {
    ...
    synergies:['Franchise Store → +5%','Fan Zone → +6%'],
    penalties:[],
...
const SLOT_TR_PT: Record<string,SlotTranslation> = {
  food_stall_basic: {
    ...
    synergies:['3 bancas em corredores diferentes → +4% adesão','Jumbotron → +5% em toda a comida','Equipa em boa forma (65%+ vitórias) → +8%'],
    penalties:['2 bancas no mesmo corredor → a segunda perde -10%','Comida Premium no mesmo corredor → -8%','Equipa em má forma (35%- vitórias) → -10%'],
  ...
  food_stall_premium: {
    ...
    synergies:['Restaurante VIP próximo → +5%','Playoffs → +15%'],
  ...
  bar: {
    ...
    synergies:['Jogo de rivalidade → +10%','Lugares Clube próximos → +5%'],
    penalties:['Os dois bares activos → cada um -3% (público dividido)'],
  ...
  restaurant_vip: {
    ...
    synergies:['Lounge Courtside → +10% adesão VIP','Camarotes Corporativos → +6%'],
    penalties:['Sem Lounge Courtside nem Camarotes → -6%','Equipa em má forma → -4%'],
  ...
  franchise_store: {
    ...
    synergies:['Mascote próxima → +5%','Equipa em boa forma → +10%','Playoffs → +20%'],
    penalties:['Equipa em má forma → -8%'],
  ...
  corporate_suites: {
    ...
    synergies:['Lounge Courtside → +15% receita de camarotes'],
    penalties:[],
  ...
  club_seats: {
    ...
    synergies:['Sem sinergia com outras bancas — receita fixa e previsível todos os jogos'],
    penalties:[],
  ...
  courtside_lounge: {
    ...
    synergies:['Restaurante VIP → pacote combinado +10%'],
    penalties:['Sem Restaurante VIP → -10% receita'],
  ...
  fan_zone: {
    ...
    synergies:['Jumbotron → +8%','Mascote → +6%'],
  ...
  mascot: {
    ...
    synergies:['Loja da Equipa → +5%','Zona de Adeptos → +6%'],
    penalties:[],
