...
import { getTeamLang, notifFAMarketWon, notifFAMarketLost } from '@/lib/notifications-helpers'
import { salaryScore, ambitionScore, popularityScore, staffQualityScore, weightedOfferScore, decisionDays } from '@/lib/fa-market-scoring'
...
// week (season week 1) — distinct from /api/cron/resolve-offers, which
...
async function resolveFreeAgencyMarket(force: boolean) {
