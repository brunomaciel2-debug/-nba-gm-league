  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-6">
      ...
      <div className="rounded-2xl p-6 mb-6"
           style={{background:'#fef3c7',border:'1px solid #5a4a00',borderTop:'4px solid #b45309'}}>
            ...
            {!ready ? (
              ...
              <span className="text-xs px-3 py-1.5 rounded-full font-semibold inline-block"
                    style={{background:votingOpen?'#0a2a10':votingClosed?'#2a0a0a':'#faf8f5',
                            color:votingOpen?'#15803d':votingClosed?'#dc2626':'#5c554e'}}>
          ...
          {tab==='vote' && <>
            ...
            {votingOpen && <>
                            ...
                            {pool.map((p:any)=>{
                              ...
                              return (
                                <button key={p.id} onClick={()=>toggleVote(conf,pos,p.id)}
                                  ...
                                  <div className="text-xs font-semibold" style={{color:isSel?'#b45309':'#1a1512'}}>
              ...
              <button onClick={saveVotes} disabled={saving||submitted||!gmTeam}
                ...
                style={{background:submitted?'#0a5a20':'#2a2000',color:submitted?'#15803d':'#b45309',
                      ...
                      {cr.map((r:any)=>{
                        ...
                        return (
                          <div key={r.id} className="rounded-xl p-3 text-center"
                               style={{background:r.is_starter?'#2a2000':'#faf8f5',border:'1px solid '+(r.is_starter?'#b45309':'#d4cdc5')}}>
