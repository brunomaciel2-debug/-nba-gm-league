...
export default function FreeAgencyRulesPage() {
  ...
  const rules = isPT ? [
    ...
    { icon:'⚖️', title:'Como o Jogador Decide', desc:'Cada agente livre escolhe a melhor proposta com base numa fórmula: 50% salário oferecido (relativo à melhor proposta que recebeu), 20% ambição pessoal (jogadores ambiciosos preferem ser a cara da equipa; menos ambiciosos preferem uma equipa com mais garantias de ganhar), 15% popularidade da franquia, 15% qualidade do staff técnico + ter uma estrela (88+ OVR) já no plantel.' },
