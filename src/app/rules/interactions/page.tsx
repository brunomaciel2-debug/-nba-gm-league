...
export default function InteractionsRulesPage() {
  ...
  const rules = isPT ? [
    ...
    { icon:'🤝', title:'Pode Envolver Dois Jogadores', desc:'Algumas interações têm um "parceiro" — por exemplo, um jogador que pede para jogar mais ao lado de um companheiro específico, ou um conflito de balneário entre dois jogadores. A tua resposta pode mexer na moral dos dois, não só de quem se queixou.' },
    ...
    { icon:'🤝', title:'Can Involve Two Players', desc:"Some interactions have a \"partner\" — for example, a player asking to play more alongside a specific teammate, or a locker-room conflict between two players. Your response can move both players' morale, not just the one who complained." },
