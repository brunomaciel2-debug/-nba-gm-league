...
export default function InteractionsRulesPage() {
  ...
  const rules = isPT ? [
    ...
    { icon:'🧠', title:'O Papel do Mental Coach', desc:'O Mental Coach da equipa controla a velocidade com que a moral se aproxima desse alvo semanal, de 6% (Gestão de Moral fraca) a 14% (Gestão de Moral no máximo) do caminho percorrido por semana — um bom Mental Coach estabiliza a equipa mais depressa nesse número, quer seja para melhor ou para pior. Também tem outros 2 atributos com efeito direto em campo: Coesão de Equipa (mais assistências, menos perdas de bola) e Gestão de Pressão (menos quebra de rendimento em jogos decisivos/clutch).' },
    ...
    { icon:'🧠', title:"The Mental Coach's Role", desc:"The team's Mental Coach controls how fast morale drifts toward that weekly target, from 6% (poor Morale Management) up to 14% (maxed-out Morale Management) of the remaining distance per week — a great Mental Coach settles a team on the right number faster, for better or worse. He also has 2 other attributes with a direct on-court effect: Team Cohesion (more assists, fewer turnovers) and Composure (less choking in clutch/decisive games)." },
