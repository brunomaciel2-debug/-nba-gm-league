...
export default function InteractionsRulesPage() {
  ...
  const rules = isPT ? [
    { icon:'📊', title:'Como a Moral Sobe e Desce, Toda as Semanas', desc:'Todas as semanas, a moral de cada jogador aproxima-se de um "alvo merecido" calculado a partir de 3 coisas reais: a % de vitórias da equipa, se ele está a jogar os minutos que o seu papel (usage) diz que merece — um titular natural que está no banco sofre, um suplente a ganhar minutos a mais tem bónus — e se a forma recente dele está acima ou abaixo da própria média da época. Isto significa que a moral pode subir OU descer por estas razões, não é só recuperação passiva.' },
    { icon:'🧠', title:'O Papel do Mental Coach', desc:'O Mental Coach da equipa controla a velocidade com que a moral se aproxima desse alvo semanal — um bom Mental Coach (Gestão de Moral alta) estabiliza a equipa mais depressa nesse número, quer seja para melhor ou para pior. Também tem outros 2 atributos com efeito direto em campo: Coesão de Equipa (mais assistências, menos perdas de bola) e Gestão de Pressão (menos quebra de rendimento em jogos decisivos/clutch).' },
    ...
    { icon:'🔍', title:'Nenhum Clique Vale Por Si Só', desc:'Ceder ou fazer um Meio-Termo NUNCA muda a moral na hora — fica registado como um compromisso, e só 2 semanas depois é que o sistema verifica, com dados reais (jogos, Ordens Semanais, propostas de contrato, créditos de treino gastos), se cumpriste mesmo. Só "Recusar" é instantâneo, porque recusar não promete nada que precise de prova.' },
    { icon:'🎯', title:'Resposta Imediata — 3 Opções', desc:'Ceder ao Pedido e Meio-Termo abrem um período de verificação de 2 semanas (maior ou menor subida de moral consoante o que realmente aconteceres a fazer). Recusar é imediato e a moral desce logo. Se nunca responderes, ao fim de 2 semanas conta automaticamente como Recusa.' },
    ...
    { icon:'📊', title:'How Morale Rises and Falls, Every Week', desc:"Every week, each player's morale drifts toward a \"deserved target\" built from 3 real things: the team's win%, whether he's actually playing the minutes his role (usage) says he deserves — a natural starter stuck on the bench suffers, a bench player earning real minutes gets a bonus — and whether his recent form is above or below his own season average. Morale can rise OR fall for these reasons, not just passively recover." },
    { icon:'🧠', title:"The Mental Coach's Role", desc:"The team's Mental Coach controls how fast morale drifts toward that weekly target — a great Mental Coach (high Morale Management) settles a team on the right number faster, for better or worse. He also has 2 other attributes with a direct on-court effect: Team Cohesion (more assists, fewer turnovers) and Composure (less choking in clutch/decisive games)." },
    ...
    { icon:'🔍', title:'No Click Is Worth Anything By Itself', desc:'Concede or Compromise never change morale on the spot — they get logged as a commitment, and only 2 weeks later does the system check, against real data (games, Weekly Orders, contract offers, training credits actually spent), whether you really followed through. Only "Dismiss" is instant, because refusing doesn\'t promise anything that needs proof.' },
    { icon:'🎯', title:'Immediate Response — 3 Choices', desc:"Concede and Compromise open a 2-week verification window (bigger or smaller morale boost depending on what you actually go on to do). Dismiss is instant and morale drops right away. Leave it unanswered for 2 weeks and it auto-resolves as a Dismiss." },
