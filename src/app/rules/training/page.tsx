...
export default function TrainingRulesPage() {
  ...
  const rules = isPT ? [
    ...
    { icon:'🔋', title:'Um Slot Cheio Espera por Ti', desc:'Os slots acumulam % de enchimento todas as semanas. Ao atingir 100%, o slot paga 10 créditos e para de encher — só volta a encher do zero depois de gastares esses 10 créditos todos. Não acumula vários lotes de créditos por gastar.' },
    ...
    { icon:'🔋', title:'A Full Slot Waits For You', desc:"Slots accumulate fill % each week. Once a slot hits 100%, it pays out 10 credits and stops filling — it only resumes from zero once you've spent all 10 of those credits. It doesn't bank multiple unspent batches." },
