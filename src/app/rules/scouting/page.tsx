export default function ScoutingRulesPage() {
  const rules = [
    ...
    { icon: '🥉', title: 'Tier 1 — 100 points', desc: 'Unlocks sessions that reveal up to 6 attributes per session, costing 10 credits. No additional financial cost — this represents your scout\'s local network and standard college film study.' },
    { icon: '🥈', title: 'Tier 2 — 250 points', desc: 'Unlocks sessions that reveal up to 14 attributes per session, costing 35 credits plus $150K from your franchise balance. Represents regional travel and in-person workouts.' },
    { icon: '🥇', title: 'Tier 3 — 400 points', desc: 'Unlocks sessions that reveal up to 24 attributes per session, costing 80 credits plus $400K from your franchise balance. Represents full international scouting trips and private workouts.' },
    ...
    <div style={{ maxWidth: 800, margin: '0 auto', padding: '24px 16px' }}>
      ...
      <div style={{
        ...
        <div style={{ fontSize: 12, color: '#6d28d9', lineHeight: 1.7 }}>
          Tier 1: 100pts → 6 reveals / 10 credits · Tier 2: 250pts → 14 reveals / 35 credits + $150K · Tier 3: 400pts → 24 reveals / 80 credits + $400K. OVR always hidden. Reveals are private to your team.
        </div>
      </div>
