...
export default function InjuriesRulesPage() {
  ...
  const rules = isPT ? [
    ...
    { icon:'🎲', title:'Como Acontece uma Lesão em Jogo', desc:'Todas as semanas, cada jogador que joga tem uma pequena hipótese de se lesionar — a hipótese sobe se a Durability for baixa, se a saúde já estiver reduzida, ou se a equipa jogar a um ritmo muito alto (Pace). O estilo do adversário também conta: um ritmo alto, uma defesa "Pressing Total" ou um ataque muito baseado em isolamento/poste aumentam o teu risco nesse jogo. Duas coisas do teu lado reduzem esse risco de verdade: o grau do teu ginásio (até -18% no Grau A) e o atributo Prevenção de Lesões do teu Preparador Físico (até -30% com um Preparador Físico no máximo).' },
    { icon:'🏋️', title:'Lesões em Treino e Fora do Profissionalismo', desc:'Um jogo (real ou amigável) não é a única forma de te lesionares. Todas as semanas, cada jogador do plantel — mesmo sem jogo agendado — corre também um pequeno risco de lesão em Treino, agravado por uma Intensidade de Treino mais alta (uma semana de Repouso reduz o risco para ~1/4 do normal; "Muito Intensa" quase duplica-o) e reduzido pelo grau do ginásio e pelo Preparador Físico, tal como nos jogos. Há ainda um risco, muito mais raro (cerca de 1 em cada 2 semanas em toda a liga), de um Incidente Fora do Profissionalismo (ex: acidente) — este não depende de nenhum investimento da tua parte, é pura sorte, tal como na vida real.' },
    ...
    { icon:'💵', title:'Despesas Médicas', desc:'Toda a lesão tem um custo médico total automático — 8 mil$ (Ligeira), 20 mil$ (Moderada), 45 mil$ (Séria), 90 mil$ (Severa) ou 180 mil$ (Risco de Carreira) — mas o Seguro que pagas mensalmente cobre 75% desse valor. A tua equipa só paga mesmo os 25% restantes: 2 mil$, 5 mil$, 11.25 mil$, 22.5 mil$ ou 45 mil$. Aparece nas tuas Finanças como despesa, já com o desconto do seguro aplicado.' },
    ...
    { icon:'📬', title:'Sempre Avisado', desc:'Recebes sempre uma notificação quando um jogador teu se lesiona, dizendo claramente onde aconteceu — num jogo, num amigável, em treino, ou fora do profissionalismo — mais o tipo de lesão, zona afetada, uma descrição real da lesão, jogos estimados de paragem, e — se aplicável — a opção de consultar um especialista diretamente a partir da notificação. Quando a lesão aconteceu num jogo real ou amigável, a notificação inclui também um botão "Ver Box Score" que te leva diretamente a esse jogo.' },
  ] : [
    ...
    { icon:'🎲', title:'How a Game Injury Happens', desc:'Every week, each player who plays has a small chance of getting hurt — the chance rises if Durability is low, if health is already reduced, or if the team plays at a very high Pace. The opponent\'s style matters too: a fast tempo, a "Full-Court Press" defense, or an offense heavy on isolation/post-ups all raise your risk in that game. Two things on your side genuinely lower that risk: your gym\'s grade (up to -18% at Grade A) and your Trainer\'s Injury Prevention attribute (up to -30% with a maxed-out Trainer).' },
    { icon:'🏋️', title:'Practice Injuries and Off-Court Incidents', desc:'A game (real or friendly) isn\'t the only way to get hurt. Every week, every player on the roster — even with no game scheduled — also carries a small Practice injury risk, made worse by a higher Training Intensity (a "Rest" week cuts the risk to roughly 1/4 of normal; "Very Intense" nearly doubles it) and lowered by gym grade and the Trainer, same as in games. There\'s also a much rarer risk (about once every 2 weeks league-wide) of an Off-Court Incident (e.g. an accident) — this one isn\'t affected by anything you invest in, it\'s pure bad luck, same as in real life.' },
    ...
    { icon:'💵', title:'Medical Bills', desc:"Every injury has a full automatic medical cost — $8K (Minor), $20K (Moderate), $45K (Serious), $90K (Severe), or $180K (Career-Threatening) — but the Insurance you pay monthly covers 75% of it. Your team only actually pays the remaining 25%: $2K, $5K, $11.25K, $22.5K, or $45K. It shows up in your Finances as an expense, already net of the insurance discount." },
    ...
    { icon:'📬', title:'Always Notified', desc:'You always get a notification when one of your players gets hurt, clearly stating where it happened — in a game, a friendly, practice, or off the court — plus the injury type, body part, a real description of the injury, estimated games out, and — when it applies — the option to consult a specialist directly from the notification. When the injury happened in a real or friendly game, the notification also includes a "View Box Score" button that takes you straight to that game.' },
  ]
    ...
    <div style={{ maxWidth:800, margin:'0 auto', padding:'24px 16px' }}>
      ...
      <div style={{ marginTop:20, padding:'16px 18px', borderRadius:12, background:'#fee2e2', border:'1px solid #fca5a5' }}>
        <div style={{ fontSize:12, color:'#dc2626', lineHeight:1.7 }}>
          {isPT
            ? 'Saúde < 50% = indisponível · 50-99% = joga pior de verdade · Recuperação semanal automática (Durability + ginásio + Physio) · Ginásio e Preparador Físico reduzem o risco de lesão em até -18%/-30% · Especialista: acelera (não cura na hora), uso único · Reincidência 1-6 semanas, recaída dura 1.5x mais · Estilo do adversário conta · Lesões também acontecem em Treino (Intensidade de Treino conta) e, muito raramente, Fora do Profissionalismo (puro azar).'
            : 'Health < 50% = unavailable · 50-99% = genuinely plays worse · Automatic weekly recovery (Durability + gym + Physio) · Gym grade and Trainer both cut injury risk by up to -18%/-30% · Specialist: speeds up (not instant), one-time use · 1-6 week reinjury risk, recurrence lasts 1.5x longer · Opponent style matters · Injuries also happen in Practice (Training Intensity matters) and, very rarely, Off the Court (pure bad luck).'}
        </div>
      </div>
    </div>
  )
