...
export default function InjuriesRulesPage() {
  ...
  const rules = isPT ? [
    ...
    { icon:'🩺', title:'Ver Especialista', desc:'Em lesões sérias, severas ou de risco de carreira, podes pagar para levar o jogador a um especialista externo — um valor único a sair do orçamento da equipa que devolve saúde imediata (quanto mais grave a lesão, mais caro e mais eficaz). Só pode ser usado uma vez por lesão.' },
    ...
    { icon:'🩺', title:'See a Specialist', desc:'On serious, severe, or career-threatening injuries, you can pay to send the player to an outside specialist — a one-time charge from the team budget that returns immediate health (the worse the injury, the more it costs and the more it helps). Usable only once per injury.' },
