...
export default function InjuriesRulesPage() {
  ...
  const rules = isPT ? [
    ...
    { icon:'📬', title:'Sempre Avisado', desc:'Recebes sempre uma notificação quando um jogador teu se lesiona, dizendo claramente onde aconteceu — num jogo, num amigável, em treino, ou fora do profissionalismo — mais o tipo de lesão, zona afetada, jogos estimados de paragem, e — se aplicável — a opção de consultar um especialista diretamente a partir da notificação.' },
  ] : [
