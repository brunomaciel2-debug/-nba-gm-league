...
export default function FinancesRulesPage() {
  ...
  const rules = isPT ? [
    ...
    { icon:'📋', title:'Aba "Social Media" — O Histórico Real', desc:'A página da tua equipa tem uma aba própria "Social Media" com o teu Social Media Manager, o contador de seguidores, e o registo de cada evento já resolvido — data, tipo, jogador envolvido, e o impacto real que teve. Nada fica escondido.' },
    ...
    { icon:'📋', title:'The "Social Media" Tab — The Real History', desc:"Your team page has its own \"Social Media\" tab with your Social Media Manager, the follower count, and a log of every resolved event — date, type, player involved, and the real impact it had. Nothing stays hidden." },
    ...
    { icon:'📦', title:'Supply Restocking — A Real Cost, Not Flat', desc:"Every concession with variable revenue (food, bar, team store) has a real cost-of-goods-sold to restock — 20% to 55% of that concession's own revenue, depending on the type. Since revenue already reflects who showed up, this cost rises and falls with real demand, not a flat number." },
