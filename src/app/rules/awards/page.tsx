...
export default function AwardsRulesPage() {
  ...
  const rules = isPT ? [
    { icon:'📅', title:'Prémio da Semana', desc:'Todas as semanas, o Jogador da Semana (um por conferência) e o Rookie da Semana (um só, liga inteira) são calculados a partir das box scores reais dos jogos dessa semana — pontos, ressaltos, assistências, roubos e bloqueios por jogo, com bónus extra para quem vence pelo menos metade dos jogos da equipa nessa semana — ou, se não, para quem faz 35+ pontos por jogo (esta segunda opção aplica-se a qualquer candidato, não só ao Rookie). É preciso ter jogado pelo menos 2 jogos nessa semana para entrar na conta.' },
    ...
    { icon:'📅', title:'Player/Rookie of the Week', desc:"Every week, Player of the Week (one per conference) and Rookie of the Week (one, league-wide) are calculated from that week's real box scores — points, rebounds, assists, steals, and blocks per game, with a bonus for winning at least half the team's games that week — or, failing that, for scoring 35+ PPG (this second option applies to any candidate, not just the Rookie award). A player needs at least 2 games that week to qualify." },
