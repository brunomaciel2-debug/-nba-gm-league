...
export default function AdminPage() {
  ...
  const items_EN = [
    ...
    {icon:'🏀',label:'Generate G-League Schedule', desc:'Rebuild the balanced 36-game G-League calendar', href:'/admin/generate-gleague-schedule', color:'#4338ca'},
  ...
  const items_PT = [
    ...
    {icon:'🏀',label:'Gerar Calendário G-League', desc:'Reconstruir o calendário equilibrado de 36 jogos da G-League', href:'/admin/generate-gleague-schedule', color:'#4338ca'},
